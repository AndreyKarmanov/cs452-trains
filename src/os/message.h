...
namespace TC {
  ...
  namespace Cmd {
    ...
    using Any =
        std::variant<Invalid, Quit, Light, Function, Speed, Switch, Reverse,
                     Stop, Go, Reset, RemoveTrains, RunTree, Direction, Nav,
                     Reg, Reserve, ReleaseReserve, FindPath>;
