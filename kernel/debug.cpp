...
//     uart_printf(
//         CONSOLE,
//         "CAN prio=%u cmd=0x%x resp=%u hash=0x%x dlc=%u data=[%x %x %x %x %x
//         %x %x %x]\n\r", frame->prio, frame->cmdid, frame->resp, frame->hash,
//         frame->dlc,
//         frame->data[0],
//         frame->data[1],
//         frame->data[2],
...
//         uart_printf(
//             CONSOLE,
//             "UNKNOWN CMD cmd=0x%x resp=%u hash=0x%x dlc=%u data=[%x %x %x %x
//             %x %x %x %x]\n\r", command.frame.cmdid, command.frame.resp,
//             command.frame.hash,
//             command.frame.dlc,
