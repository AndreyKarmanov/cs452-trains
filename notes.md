...
<!-- ../../qemu/build/qemu-system-aarch64 -M raspi4b -cpu cortex-a72 -m 2G -serial stdio -display none -kernel iotest.img -->
...
- Fast interrupt is legacy mechanism from 32 bit. We don't use this, as it's legacy. It banked some registers for you, which made it faster as no state had to be saved in some simpler cases. interrupts in the cpu can be masked
